# Generated by Powerlevel10k configuration wizard on 2019-11-04 at 15:19 MSK.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 51841.
# Wizard options: awesome-fontconfig, large icons, lean, time, 2 lines, dotted, sparse,
# many icons, concise.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
      ...
      nogo_version              # go version (https://golang.org)
      norust_version            # rustc version (https://www.rust-lang.org)
      nodotnet_version          # .NET version (https://dotnet.microsoft.com)
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX="%F{014}\u256D\u2500%F{white}"
  ...
  typeset -g POWERLEVEL9K_DIR_HOME_FOREGROUND=137
  typeset -g  POWERLEVEL9K_DIR_HOME_SUBFOLDER_FOREGROUND=137
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=137
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=097
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=184
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_CONTEXT_DEFAULT_FOREGROUND=2
  # Default context format: %n is username, %m is hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n%f@%m'
  ...
  typeset -g POWERLEVEL9K_HISTORY_FOREGROUND=15
